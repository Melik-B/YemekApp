    ...
    public class DatabaseController : Controller
    {
        public IActionResult Seed()
        {
            using (YemekAppContext db = new YemekAppContext())
            {
                ...
                {
                    db.Database.ExecuteSqlRaw("dbcc CHECKIDENT ('YemekAppYemekTarifleri', RESEED, 0)");
                    db.Database.ExecuteSqlRaw("dbcc CHECKIDENT ('YemekAppMalzeme', RESEED, 0)");
                ...
                {
                    Adi = "1. 2 adet yumurta\n 2. 2 yemek kaşığı şeker\n 3. 1 su bardağı süt\n 4. 1,5 su bardağı un\n 5.1 paket kabartma tozu\n 6. 1 paket vanilya",
